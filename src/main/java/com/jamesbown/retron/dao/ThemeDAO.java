...
public class ThemeDAO {
    ...
    public synchronized void createTheme(Theme theme) {
        themes.add(theme);
    }
    ...
    public synchronized void addVoteToTheme(String id, Vote v) {
    ...
    public synchronized boolean haveNVotesBeenCast(int n) {
    ...
    public synchronized ActionsPhaseMessage decideOnActionThemes() {
